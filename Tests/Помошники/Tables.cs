...
namespace UWP.Помошники
{
    class Tables
    {
        public static readonly byte[] _pi = {
        ...
        public static readonly byte[] _reversePi = {
        ...
        public static byte[] StribogSbox ={
